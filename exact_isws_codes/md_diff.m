% Makes a centered differentiation matrix, uses up/down wind at the ends
% ord can be 1 (1st deriv) or 2 (2nd deriv)
function D = md_diff(dx, N, ord, ends)
    a=[0;0;0];
    a(ord+1)=1;

    dx2 = dx*dx; dx3 = dx2*dx; dx4 = dx3*dx;
