...
% on 0<z<H with phi(0)=phi(H)=0
  ...
  refnum=15        
  plot(c1s/c1s(refnum),z0s/H,'bo',r10_1/r10_1(refnum),z0s/H,'ko',r01_1/r01_1(refnum),z0s/H,'ro')
  hold on
  plot([-2.5 2.5],[1 1]*z0s(refnum)/H)
  ylabel('pycnocline center scaled by H')
  ...
  set(gcf,'DefaultLineLineWidth',2,'DefaultTextFontSize',12,...
            'DefaultTextFontWeight','bold','DefaultAxesFontSize',12,...
              'DefaultAxesFontWeight','bold');
  plot(c2s/c2s(refnum),z0s/H,'bo',r10_2/r10_2(refnum),z0s/H,'ko',r01_2/r01_2(refnum),z0s/H,'ro')
  hold on
  plot([-2.5 2.5],[1 1]*z0s(refnum)/H)
  axis([-2.5 2.5 0 1])
  ylabel('pycnocline center scaled by H')
